	...
	_createClass(Chart, [{
		...
		value: function paintLegend(context) {
			...
			this.legendList.forEach(function (legendScetion, j) {
				...
				context.translate(Math.floor((_this2.stage2d.width - totalWidth + 16) / 2), 20 + 20 * j);
	...
	_createClass(ChartPie, [{
		...
		value: function foregroundPaint(scene) {
			...
			this.foregroundScene.paint(function (context) {
				...
				//遍历并绘制
				_this4.shapeList.forEach(function (shape) {
					shape.paint(context);
				});

				_this4.paintLegend(context);
			});
		}
...
var Pie = exports.Pie = function (_Shape) {
    ...
    _createClass(Pie, [{
        ...
        key: 'paintLegend',
        value: function paintLegend(context, x, y) {
            context.save();
            context.fillStyle = this.pattern;
            context.beginPath();
